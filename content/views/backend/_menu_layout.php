...
$menu_down[] = array('id' => 5, 'text' => 'Cutome');
$menu_down[] = array('id' => 6, 'text' => 'Extemal');

$_SESSION['parent'] ? $_SESSION['parent'] = $_SESSION['parent'] + 1 : $_SESSION['parent'] = 1;
?>

<div class="content_content">
	<div class="box_firt"><?php echo zen_draw_input_field('menu[$parent_id][name]','','class="menu_url"');?><span class="add"><?php echo zen_image_button('add.png');?></span><span class="remove"><?php echo zen_image_button('add.png');?></span></div>
