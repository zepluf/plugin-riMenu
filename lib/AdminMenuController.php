...
class AdminMenuController extends Controller{
	...
	public function indexAction(Request $request){
		$menus_tree = Plugin::get('riMenu.Tree')->getMenusTree();
		$this->view->getHelper('php::holder')->add('main', $this->view->render('riMenu::backend/_menu_list.php', array('menus' => $menus_tree[0]['sub_menus'], 'menus_tree' => $menus_tree)));
		return $this->render('riMenu::backend/admin_layout.php');
	}
	...
	public function editAction(Request $request){
		...
		$types = Plugin::get('riPlugin.Settings')->get('riMenu.types');
		...
		$this->view->getHelper('php::holder')->add('main', $this->view->render('riMenu::backend/_menu_edit.php', array(
			'menus_id' => $menus_id,
	...
	/*public function indexAction(Request $request){
	 return $this->render('riMenu::backend/admin_layout.php', array('menus' => Plugin::get('riMenu.Tree')->getVerticalMenu(191)));
	 }  */
